...
class UpdatePasswordController extends AbstractController
{
     ...
     * @OA\Response(response=400, description="The user should be administrator or employee | The account is disabled | Invalid password | The newPasswordConfirmation and newPassword should have the same value")
     *
